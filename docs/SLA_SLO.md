...
- Integridad/Perdida de datos: perdida permitida 0 en operaciones de `orders` y `reports` bajo failover.
- Escalabilidad: soportar 3x carga base agregando replicas de app1/app2 y replicas de BD sin cambios de codigo.

## Acuerdos de Nivel de Servicio (SLA)
- Disponibilidad garantizada: 99.5% mensual (penalizacion si cae debajo de 99.9% segun ejemplo).
